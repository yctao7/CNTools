...
# python identify.py --ds_path data/HLT/HLT_ds.pkl --out_dir cn/HLT/CC --n_cns 11 --Naive 3 --HMRF 29 9 1 --seed 0 --verbose CC --m 20

python identify.py --ds_path data/HLT/HLT_ds.pkl --out_dir cn/HLT/CFIDF --n_cns 11 --Naive 3 --HMRF 29 9 1 --seed 0 --verbose CFIDF --eps 23 --r 0.8 --include_neighbors

# python identify.py --ds_path data/HLT/HLT_ds.pkl --out_dir cn/HLT/CNE --n_cns 11 --Naive 3 --HMRF 29 9 1 --seed 0 --verbose CNE --eta 2 --include_neighbors

# python identify.py --ds_path data/HLT/HLT_ds.pkl --out_dir cn/HLT/Spatial_LDA --n_cns 11 --Naive 3 --HMRF 29 9 1 --verbose Spatial_LDA --eps 50 --b 0.025