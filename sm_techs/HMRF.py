...
def build_eps_graphs(ds, eps, include_neighbors, n_included):
    data = ds.data
...
def HMRF(ds, cns, n_cns, eps, beta, include_neighbors=False, n_included=100, max_iter=50, max_iter_no_change=3):
    eps_graphs = build_eps_graphs(ds, eps, include_neighbors, n_included)
